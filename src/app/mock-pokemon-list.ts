...
export const POKEMONS: Pokemon[] = [
    ...
    },
    {
        ...
        hp: 16,
        cp: 2,
        picture: "https://www.pokepedia.fr/images/thumb/9/9b/Aspicot-RFVF.png/250px-Aspicot-RFVF.png",
    ...
    },
    {
        ...
        hp: 14,
        cp: 5,
        picture: "https://www.pokepedia.fr/images/thumb/7/7d/Piafabec-RFVF.png/250px-Piafabec-RFVF.png",
        types: ["Normal", "Vol"],
        created: new Date()
    },
    {
        ...
        hp: 16,
        cp: 4,
        picture: "https://www.pokepedia.fr/images/thumb/5/56/Abo-RFVF.png/250px-Abo-RFVF.png",
        types: ["Poison"],
        created: new Date()
    },
    {
        ...
        hp: 21,
        cp: 7,
        picture: "https://www.pokepedia.fr/images/thumb/7/76/Pikachu-DEPS.png/250px-Pikachu-DEPS.png",
        types: ["Electrik"],
        created: new Date()
    },
    {
        ...
        hp: 19,
        cp: 3,
        picture: "https://www.pokepedia.fr/images/thumb/6/66/Sabelette-RFVF.png/250px-Sabelette-RFVF.png",
        types: ["Normal"],
        created: new Date()
    },
    {
